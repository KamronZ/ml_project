...
Prerequisites:
	Python 3.9 with the following supporting Libraries: Certifi, Click, Colorama, Flask, Gunicon, Itsdangerous, Jinja2,MarkupSafe, Numpy, Pytz, Sklearn, Viola, Werkzeug, Wincerstore, Dash, Pandas. 
1)	Install Prerequisites
if pip package manager is installed:  
a.	cd to directory that contains requirements.txt
b.	activate vitrualenv
c.	run pip install -r requirements.txt in command shell

2)	Extract ml_diabetes.rar into desired directory
3)	Run app.py
4)	Through browser, enter http://127.0.0.1:5000/
